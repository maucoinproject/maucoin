...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Maucoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"maucointools.com", "45.55.73.38"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"maucointools.com", "testnet-seed.maucointools.com"},
    {"xurious.com", "testnet-seed.mau.xurious.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Maucoin is probably already running."), addrBind.ToString().c_str());
        else
